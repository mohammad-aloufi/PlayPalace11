...
battleship-hit-self = Khai hỏa tọa độ { $coord }. Trúng đích!
...
battleship-miss-self = Khai hỏa tọa độ { $coord }. Trượt.
...
battleship-sunk-self = { $ship } của địch đã bị tiêu diệt!
...
battleship-victory-self = Chiến thắng! Toàn bộ hạm đội địch đã bị tiêu diệt.
...
battleship-already-shot = Tọa độ này đã bị bắn rồi.
battleship-switch-to-shots = Bạn đang xem vùng biển của mình. Nhấn V để chuyển sang bản đồ mục tiêu.
