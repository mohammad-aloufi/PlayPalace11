...
# Option descriptions
lastcard-desc-winning-score = Score needed to win the game.
lastcard-desc-hand-size = Number of cards dealt to each player at the start of a round.
lastcard-desc-turn-timer = Time limit for each player's turn. 0 means unlimited.
lastcard-desc-draw-until-playable = Keep drawing cards until you get one you can play.
lastcard-desc-draw-limit = Maximum cards drawn per turn when draw-until-playable is on. 0 means unlimited.
lastcard-desc-stacking = Allow stacking Draw Two and Wild Draw Four cards to pass the penalty along.
lastcard-desc-skip-card-rule = Whether a Skip card skips only the next player or everyone.
lastcard-desc-reverse-two-players = How Reverse cards behave in a two-player game.
lastcard-desc-zero-card-rule = Special effect when a zero card is played.
lastcard-desc-seven-card-rule = Special effect when a seven card is played.
lastcard-desc-jump-in = Allow players to play out of turn if they have an identical card.
lastcard-desc-force-play = Automatically play a drawn card if it is playable.
lastcard-desc-last-card-callout = Require players to call Last Card when they have one card left.
lastcard-desc-challenge-wild-draw-four = Allow challenging whether a Wild Draw Four was played legally.
lastcard-desc-allow-multiple-play = Allow playing multiple cards of the same rank in one turn.
lastcard-desc-scoring-mode = How points are awarded at the end of each round.
lastcard-desc-buzzer-enabled = Enable the buzzer button to catch players who forget to call Last Card.
lastcard-desc-interrupt-timer = Seconds allowed for reactions like jump-ins and challenges.
lastcard-desc-max-hand-size = Maximum number of cards a player can hold. 0 means unlimited.
